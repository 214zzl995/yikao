...
/**
 * (SingleChoice)表数据库访问层
 *
 * @author leri
 * @since 2021-01-07 10:22:37
 */
public interface SingleChoiceDao {
     ...
     *
     * @param entities List<SingleChoice> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<SingleChoice> entities);
     ...
     * @return 影响行数
     */
    int insertOrUpdateBatch(@Param("entities") List<SingleChoice> entities);
